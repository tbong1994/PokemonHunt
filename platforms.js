...
function createPlatform(){
	...
	for(i =0;i<40;i++){
		var platform = platforms.create(Math.random()*(game.world.width)+0,Math.random()*(game.world.height-400)+400,'platform1');
	...
	for(i =0;i<30;i++){
		var platform = platforms.create(Math.random()*(game.world.width)+0,Math.random()*(game.world.height-400)+400,'platform2');
		platform.scale.setTo(1,1);
